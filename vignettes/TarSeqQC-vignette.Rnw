...
\affil[1]{Laboratory of Molecular and Cellular Therapy, Instituto
Leloir-CONICET, Argentina}
\affil[2]{CONICET-Universidad Cat\'{o}lica de C\'{o}rdoba, Argentina}
...
\end{figure}
\par
Figure \ref{fig:plotInOut} showsc that more than half sequence reads belong to 
genomic regions outside of the expected amplicon regions (red bars). This is a
...
\begin{figure}[!htp]
    \begin{center}
        \includegraphics[scale=0.7]{plotCPP.pdf}
    \end{center}
...
\begin{figure}[!htp]
    \begin{center}
        \includegraphics[scale=0.7]{perfExplCCP.pdf}
    \end{center}
